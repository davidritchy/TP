...
<h2>@lang('Make a modification')</h2>
  ...
  @method('PUT')
    ...
    <div class="col-md-6 position-relative ms-5">
      <label for="validationTooltip02" class="form-label">@lang('Address')</label>
    ...
    <div class="col-md-6 position-relative ms-5">
      <label for="validationTooltip02" class="form-label">@lang('Birthday')</label>
    ...
    <div class="col-md-6 position-relative ms-5">
      <label for="validationTooltip02" class="form-label">@lang('Number phone')</label>
    ...
    <div class="col-md-6 position-relative ms-5">
      <label for="validationTooltipUsername" class="form-label">@lang('E-mail')</label>
    ...
    <div class="col-md-6 position-relative ms-5">
      <label for="validationTooltip04" class="form-label">@lang('City')</label>
      ...
      <button type="submit" class="btn btn-success mt-4 btn-lg" style="margin-left: 45%">@lang('Update')</button>
    </div>
  </form>
</div>
@endsection